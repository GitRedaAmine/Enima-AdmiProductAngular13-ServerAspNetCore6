    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Brands", x => x.uuid);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageUrls", x => x.uuid);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("67ca6a64-f730-42fd-a64e-79fa71689c96"), "default brand" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "uuid", "Name" },
                values: new object[] { new Guid("19a60e1f-99ed-44b6-9fbb-6fe2e84d59e9"), "default Categorie" });
